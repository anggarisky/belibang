    ...
    return (
        <GuestLayout>
            ...
            <form onSubmit={submit}>
                ...
                <div className="flex flex-col gap-y-5 items-center justify-end mt-4">
                    {canResetPassword && (
                        <Link
                    ...
                    <PrimaryButton className="text-base py-4 rounded-full px-10 text-white bg-indigo-700" disabled={processing}>
                        Log in
                    </PrimaryButton>
